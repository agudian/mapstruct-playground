...
public @interface GlobalMapping {
    /**
     * Marker type to indicate no restriction on {@link GlobalMapping#sourceType()} or
     * {@link GlobalMapping#targetType()}.
     */
     ...
     */
    Class<?> sourceType() default Any.class;
     ...
     */
    Class<?> targetType() default Any.class;
